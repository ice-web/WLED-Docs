...
[Domestic Automation LLC] (https://www.amazon.com/dp/B0BPMNV1X4?ref=myi_title_dp) | "LED Chauffeuse" comes with internal or external antenna variants. Includes embedded Relay, Fusing and Power Injection output terminal. PIR motion, Button, and IO Breakout (for dry contacts) modules also available. All parts include plastic track to aid in mounting. Optional modules connect together with 6p6c straight cabling. - Michèle
