...
[LED Chauffeuse] (https://www.domestic-automation.com) | Preassembled & expandable with internal and external antenna variations. "LED Chauffeuse" is the heart of the "Vegas Lights" system. Designed to control individually addressable LEDs such as WS2812b or WS2811 5vdc. The “LED Chauffeuse” comes with "WLED" pre-installed. LED, Power and optional modules connect with no tools needed. Easily expandable via RJ12 connector to connect optional modules: "Button", "PIR Motion" or “Breakout” sold separately. 
